...
(function(){
  ...
  const EMBEDDED_PROJECTS = [
    {id:"watch-swipe-surface",title:"watchOS Swipe Surface",subtitle:"The Apple Watch as a touch surface for other Apple devices",category:"Research / HCI",tags:["HCI", "UX", "Software", "Research", "Personal"],description:"The Apple Watch is sold as a health tracker that happens to have a screen. This treats it as the opposite: a very small touch surface that happens to be worn. Take away the strap and the sensors and what remains is a palm-sized puck with a bright touchscreen, a haptic engine and a radio link to every other Apple device its owner carries.",github:"https://github.com/RabiatS/watchos-swipe-surface",demo:null,caseStudy:"case-studies/watch-swipe-surface.html",status:"in-progress",images:["assets/img/projects/watch-swipe-surface/hero.jpg"],year:"2026"},
    {id:"lantern",title:"Lantern",subtitle:"A language model that lives on your phone",category:"iOS / Health / ML Deployment",tags:["ML", "Software", "HCI", "Personal"],description:"An iPhone app that runs a quantized LLM entirely on the phone with MLX Swift. No server, no API key, no account. After the weights download once it works in airplane mode, and the readout on screen shows what that costs while it writes: tokens per second, memory in use, and the thermal state.",github:"https://github.com/RabiatS/lantern",demo:null,caseStudy:"case-studies/lantern.html",status:"in-progress",images:["assets/img/projects/lantern/chat.jpg"],year:"2026"},
    {id:"ember",title:"Ember",subtitle:"Photos for a small circle, gone in a week",category:"Mobile / Product",tags:["Software", "HCI", "Product", "Personal"],description:"A private photo app for a handful of friends. A drop lasts a week, loses resolution as it ages, then lifts away into drifting light and is gone. Every drop is sealed under its own key before it leaves the phone, and expiry destroys that key, so whatever bytes survive anywhere are noise.",github:"https://github.com/RabiatS/ember",demo:null,caseStudy:"case-studies/ember.html",status:"complete",images:["assets/img/projects/ember/wordmark-ember.jpg"],year:"2026"},
    {id:"visionpro-wrist-haptics",title:"VisionPro Wrist Spatial Feedback",subtitle:"Apple Watch haptics for Vision Pro interactions",category:"XR / Unity / Immersive",tags:["XR", "HCI", "UX", "Spatial Intelligence", "Research", "Software"],description:"Spatial interfaces tell you what happened by showing you. That fails the moment you are looking somewhere else. This turns Vision Pro interaction events into brief, semantic Apple Watch haptics, so you can feel selection, progress, success and failure instead of having to watch for them.",github:"https://github.com/RabiatS/VisionProWristSpatialFeedback",demo:null,caseStudy:"case-studies/visionpro-wrist-haptics.html",status:"complete",images:["assets/img/projects/visionpro/hero-pinch.jpg"],year:"2026"},
    {id:"ai-deployment-gap",title:"The AI Deployment Gap",subtitle:"Essay and study prototype on task-embedded affordances",category:"Research / HCI",tags:["Research", "HCI", "Software", "Personal"],description:"We ship new models faster than anyone learns what the last ones could already do. A long essay on why that gap is an interface problem rather than a capability one, plus a two-condition study prototype that tests a task-first alternative to the blank chat box.",github:null,demo:null,caseStudy:"case-studies/ai-deployment-gap.html",status:"in-progress",images:["assets/img/projects/ai-deployment-gap/hero.jpg"],year:"2026"},
    {id:"text-to-braille",title:"Text to Braille",subtitle:"Adaptive refreshable braille display",category:"Hardware / Embedded",tags:["Hardware", "ML", "Research", "Personal"],description:"Text to braille translation is already solved. The unsolved problem is bandwidth: braille reads at about 125 wpm through a 20 to 40 character slit while speech arrives at about 150 wpm, so a deafblind reader in a live conversation falls behind and never catches up. Deciding what deserves the cells is the part worth building.",github:"https://github.com/RabiatS/text-to-physical-adaptive-braille",demo:null,caseStudy:null,status:"in-progress",images:["assets/img/projects/text-to-braille/hero-text.jpg"],year:"2026"},
    {id:"eyeswipe",title:"EyeSwipe",subtitle:"On-device gaze navigation for short-form video",category:"iOS / Health / ML Deployment",tags:["CV", "HCI", "Software", "Personal"],description:"Auto-scroll is fine for passive watching, but that is not how people actually move through short-form content. Most of the time we skip, and skipping is still manual. EyeSwipe maps a short gaze hold on a screen region to the next action, so navigation is hands free.",github:"https://github.com/RabiatS/Eye_tracking_auto_Scroll_navigation",demo:null,caseStudy:null,status:"in-progress",images:["assets/img/projects/eyeswipe/hero.jpg"],year:"2026"},
    {id:"local-multimodal-memory",title:"Local Multimodal Memory Explorer",subtitle:"Private on-device semantic photo search",category:"iOS / Health / ML Deployment",tags:["ML", "HCI", "Research", "Personal"],description:"Can a private, on-device multimodal index help people rediscover their own moments more naturally than albums and folders, while still letting them see and correct what the AI inferred? A native SwiftUI prototype that indexes photos and written reflections locally and shows why each result came back.",github:"https://github.com/RabiatS/LocalMultimodalMemoryExplorer",demo:null,caseStudy:null,status:"in-progress",images:["assets/img/projects/local-multimodal-memory/hero.jpg"],year:"2026"},
    ...
    {id:"ai-music-identifier",title:"AI Music Identifier",subtitle:"Is this song made by a person? On-device, offline",category:"Applied ML / CV / Video",tags:["ML", "Audio", "iOS", "Personal"],description:"A binary classifier for AI-generated music from ten seconds of audio, exported to Core ML and run on an iPhone with no network. Test AUC 0.984, and 80% recall on a generator it was never trained on.",github:null,demo:null,caseStudy:"case-studies/ai-music-identifier.html",status:"complete",images:["assets/img/projects/ai-music-identifier/hero.jpg"],year:"2026"},
